		...
		<div class="content">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li class="active"><i class="fa fa-table"></i> Request
							Management</li>
					</ol>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Device Resource</div>
									...
									<tbody>
										...
										<tr>
											...
											<td><a type="button" class="btn btn-success btn-sm"
												href="javascript:customApplyDevice('e0c9a87390594190951bd81be16c6b91','028488214142432e901759db1f1bfb7c');">Apply</a>
										...
										<tr>
											...
											<td>Available</td>
											<td><a type="button" class="btn btn-success btn-sm"
												href="javascript:customApplyDevice('704aff96e3254875b7ff4764fea5f12a','ab77e047ad12465aac39f0a134aa2c9c');">Apply</a>
										...
										<tr>
											...
											<td>Available</td>
											<td><a type="button" class="btn btn-success btn-sm"
												href="javascript:customApplyDevice('42a5c9a832934ac8a0d8c0936489e4cb','ab77e047ad12465aac39f0a134aa2c9c');">Apply</a>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							Requested Device <a type="button" class="btn btn-primary btn-sm"
			...
			<!-- Apply Device custom -->
			<div class="modal fade" id="CustomApplyDevice" tabindex="-1"
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<ul id="myTab" class="nav nav-tabs">
								<li class="active" id="customapplydevice-1"><a
									href="http://9.110.180.218:8080/agent/application#home"
									data-toggle="tab">Web Access</a></li>
								<li class="" id="customapplydevice-2"><a
									href="http://9.110.180.218:8080/agent/application#profile"
									data-toggle="tab">VM+Mobile</a></li>
							</ul>
							<div id="myTabContent" class="tab-content">
								<div class="tab-pane fade active in" id="home">
									<p style="padding-top: 5px;">Device will be attached to
										Service VM automatically.</p>
									<form
										action="http://9.110.180.218:8080/agent/application/customcreate"
										method="post" id="custom-apply-device-form-1"
										class="form-horizontal" role="form">
										<div class="form-group">
											<label for="rentDuration-1" class="col-sm-4 control-label">Rent
												Duration</label>
											<div class="col-sm-8">
												<input type="text" class="form-control" id="rentDuration-1"
													required="required" name="rentDuration">
											</div>
										</div>
										<div class="row">
								...
								<div class="tab-pane fade" id="profile">
									...
									<form
										action="http://9.110.180.218:8080/agent/application/customcreate"
										method="post" id="custom-apply-device-form-2"
										class="form-horizontal" role="form">
										<div class="form-group">
											<label for="rentDuration-1" class="col-sm-4 control-label">Attach
												VM</label>
											<div class="col-sm-8">
												<table id="vm-list">
			...
			<script type="text/javascript">
				function customApplyDevice(id, esxHostId) {
					var webAccessAction = $("#custom-apply-device-form-1")
							.attr("action");
					$("#custom-apply-device-form-1")[0].reset();
					$("#custom-apply-device-form-2")[0].reset();
					$("#custom-apply-device-form-1").attr(
							"action",
							webAccessAction + "?requestDeviceId=" + id
									+ "&esxHostId=" + esxHostId);
					$
							.ajax({
								type : "get",
								url : "/agent/application/getVMListByHostId/"
										+ esxHostId,
								dataType : "json",
								success : function(data) {
									...
									if (data == null) {
										$("#vm-list")
												.append(
														"<tr><td><span style='color:red;font-style:italic'>* No vm is available,please use web access way.</span></td></tr>");
									}
									$(data)
											.each(
													function(index, item) {
														var content = "<tr>";
														content += "<td><input type='radio' id='requestVmId-'"
																+ (index + 1)
																+ " name='requestVmId' value='"
																+ item.id
														...
														$("#vm-list").append(
																content);
														$(
																'#custom-apply-device-form-2 input')
																.iCheck(
																		{
			...
			<!-- Apply Device -->
			<div class="modal fade" id="ApplyDevice" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="http://9.110.180.218:8080/agent/application/create"
							method="post" id="apply-device-form">
							<div class="modal-body">
								<div class="row">
									<div class="col-md-6">
											...
											<tbody>
												<tr>
													...
													<td style="padding-left: 5px;"><input type="text"
														class="form-control" name="rentDuration" id="rentDuration"
														required=""></td>
												</tr>
											</tbody>
										</table>
			...
			<!-- Install APK -->
			<div class="modal fade" id="installApk" tabindex="-1" role="dialog"
				aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<h4 class="modal-title" id="myModalLabel">Upload an apk to
								install</h4>
						</div>
						<form
							action="http://9.110.180.218:8080/agent/application/installApk"
							method="post" id="installApk-form" enctype="multipart/form-data"
							class="form-horizontal" role="form">
							<div class="modal-body">
								<div class="form-group">
									<label for="file" class="col-sm-3 control-label">File
										input *</label>
									<div class="col-sm-9">
										<input type="file" name="file" title="Choose a file"
											required="">
									</div>
								</div>

								<div class="form-group">
									<label for="appName" class="col-sm-3 control-label">App
										name *</label>
									<div class="col-sm-9">
			...
			<!-- Uninstall APK -->
			<div class="modal fade" id="uninstallApk" tabindex="-1" role="dialog"
				aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<h4 class="modal-title" id="myModalLabel">Select uninstall
								component</h4>
						</div>
						<form
							action="http://9.110.180.218:8080/agent/application/uninstallApk"
							method="post" id="uninstallApk-form" class="form-horizontal"
							role="form">
							<div class="modal-body">
								<div class="row">
			...
			<script type="text/javascript">
				function uninstallApk(id) {
					$
							.ajax({
								type : "get",
								url : "/agent/application/listInstallApks?deviceRequestId="
										+ id,
								dataType : "json",
								success : function(data) {
									...
									$(data)
											.each(
													function(index, item) {
														var content = "<tr>";
														content += "<td><input type='radio' id='fileId-'"
																+ (index + 1)
																+ " name='fileId' value='"
																+ item.id
																+ "' required='required'/></td>";
			...
			<!-- Reboot -->
			<div class="modal fade" id="rebootDevice" tabindex="-1" role="dialog"
				aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<form action="http://9.110.180.218:8080/agent/application/reboot"
							method="post" id="rebootDevice-form">
							<div class="modal-body">
								<input id="deviceRequestId-reboot" name="deviceRequestId"
									type="hidden">
								<p>Please do not reboot device until you find it can't be
									controlled.</p>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default btn-sm"
			...
			<!-- Push File -->
			<div class="modal fade" id="pushFile" tabindex="-1" role="dialog"
				aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<h4 class="modal-title" id="myModalLabel">Choose a file to
								upload</h4>
						</div>
						<form
							action="http://9.110.180.218:8080/agent/application/pushFile"
							method="post" id="pushFile-form" enctype="multipart/form-data"
							class="form-horizontal" role="form">
							<div class="modal-body">
								<div class="form-group">
									<label for="vmName" class="col-sm-3 control-label">File
										input *</label>
									<div class="col-sm-9">
										<input type="file" name="file" title="Choose a file"
											required="">
								...
								<div class="form-group">
									<label for="devicePath" class="col-sm-3 control-label">Device
										Path *</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="devicePath"
											id="devicePath" required="">
									</div>
								</div>
							</div>
							<div class="modal-footer">
			...
			<!-- Pull File -->
			<div class="modal fade" id="pullFile" tabindex="-1" role="dialog"
				aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<h4 class="modal-title" id="myModalLabel">Pull File from
								Current Device</h4>
						</div>
						<div class="modal-body">
							<div class="form-group">
								<label for="devicePath" class="col-sm-3 control-label">Device
									Path *</label>
								<div class="col-sm-6">
									<input type="hidden" name="deviceRequestId"
										id="deviceRequestId-pull"> <input type="text"
										class="form-control" name="devicePath" id="devicePath-pull"
										required="">
								</div>
								<div class="col-sm-3">
									<a type="button" class="btn btn-primary btn-sm"
										href="javascript:retrieveFile();" id="retrieve-button">Retrieve</a>
								</div>
							</div>
							<div class="form-group">
								<div class="col-sm-12" id="file-container"></div>
							</div>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default btn-sm"
					...
					$
							.ajax({
								...
								beforeSend : function(XMLHttpRequest) {
									$("#file-container")
											.append(
													"<img src='/agent/static/image/ajax-loading-image.gif'/>");
									$("#file-container .retrieved-file")
											.remove();
			...
			<!-- Open Control Panel -->
			<div class="modal fade" id="control-panel" tabindex="-1"
				role="dialog" aria-labelledby="" installapk""="" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
						...
						<div class="modal-body">
							<iframe id="control-frame" style="zoom: 0.6;" height="650" src=""
			...
			<div class="modal fade" id="historyUsage" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" style="width: 70%;">
					<div class="modal-content">
						...
						<form action="http://9.110.180.218:8080/agent/vm/create"
									...
									<div class="col-lg-3">
										<ul class="pager" style="margin: 0;">
											<li class="previous btn-sm"><a
												href="http://9.110.180.218:8080/agent/application#">Previous</a></li>
											<li class="next btn-sm"><a
												href="http://9.110.180.218:8080/agent/application#">Next</a></li>
										</ul>
									</div>
										...
										<div class="form-group">
											<div class="input-group">
												<input class="form-control btn-sm" size="" type="text"
													...
													href="http://9.110.180.218:8080/agent/application#"><span
